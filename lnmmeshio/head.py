...
MULTIPLE_OPTION_SECTIONS = [re.compile(r"^MATERIALS$")]

TEXT_SECTIONS = [re.compile(r"^TITLE$"), re.compile(r"^$")]
...
class BaseLine:
    ...
    def get_lines(self):
        raise NotImplementedError(
            "This method is not implemented, but should be by the derived class"
        )
