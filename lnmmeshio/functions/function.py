...
class Function:
    ...
    def add_component(self, component: Component):
        if component.pos < len(self.components):
            ...
            raise RuntimeError("There is at least one component missing. Got component {0} but expected {1}".format(component.pos, len(self.components)))
                    ...
                    if component is not None:
                        ...
                        if curr_function is None:
                            ...
                            if i-1 != len(functions):
                                raise RuntimeError("The functions are not in the correct order")
