...
class TestHead(unittest.TestCase):
    ...
    def test_write_head(self):
        ...
        problemtype.append(
            SingleOptionLine("PROBLEMTYP", "Structure", "This is a fancy comment")
        )
        ...
        self.assertEqual(
            lines[5],
            "PROBLEMTYP                      Structure // This is a fancy comment",
        )
    ...
    def test_single_option_line(self):
        ...
        self.assertRegexListEqual(
            m.get_lines(), [re.compile(r"^key\s+value\s+//\s+small comment$")]
        )
        ...
        self.assertRegexListEqual(
            ...
            [
                re.compile(
                    r"^\s*//\s+this is a very long comment that must be placed on an extra line before$"
                ),
