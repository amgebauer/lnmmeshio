...
class TestOverride(unittest.TestCase):
    ...
    def setUp(self):
        ...
        if not os.path.isfile(os.path.join(script_dir, 'tmp', 'cube.mesh')):
            shutil.copy(os.path.join(script_dir, 'data', 'cube.mesh'), os.path.join(script_dir, 'tmp', 'cube.mesh'))
    ...
    def test_override_write(self):
        ...
        with self.assertRaises(FileExistsError):
            lnmmeshio.write(os.path.join(script_dir, 'tmp', 'cube.mesh'), d, override=False)
    ...
    def test_override_write_mesh(self):
        ...
        with self.assertRaises(FileExistsError):
            lnmmeshio.write_mesh(os.path.join(script_dir, 'tmp', 'cube.mesh'), d, override=False)
        
        lnmmeshio.write_mesh(os.path.join(script_dir, 'tmp', 'cube.mesh'), d, override=True)