...
class TestResultDescription(unittest.TestCase):
    ...
    def test_read_description(self):
        ...
        self.assertAlmostEqual(desc1.value, 8.00901026463622223e+00)
        ...
        self.assertAlmostEqual(desc2.value, 8.00901026463622223e+00)
    ...
    def test_write_description(self):
        ...
        desc1 = StructureResultDescription(d.discretization.nodes[0], 'dispx', 1e-4, 1e-20)
        desc2 = StructureResultDescription(d.discretization.elements.structure[0], 'dispx', 1e-4, 1e-20)

        self.assertEqual(desc1.get_line(), 'STRUCTURE DIS structure NODE 1 QUANTITY dispx VALUE 0.0001 TOLERANCE 1e-20')
        self.assertEqual(desc2.get_line(), 'STRUCTURE DIS structure ELEMENT 1 QUANTITY dispx VALUE 0.0001 TOLERANCE 1e-20')
    ...
    def test_parse_result_descriptions(self):
        ...
        self.assertAlmostEqual(l[0].value, 8.00901026463622223e+00)
        ...
        self.assertAlmostEqual(l[1].value, 8.00901026463622223e+00)
